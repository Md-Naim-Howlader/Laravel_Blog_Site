...
<aside class="w-3/12 p-5 bg-blue-100">
    <div>
    ...
    <div class="mt-4">
        ...
        <div class="mt-4">
            ...
            <div class="mb-5">
                <h3 class="text-xl mb-3 pb-1 border border-b-1 border-b-black border-dashed transition hover:text-blue-600 hover:border-b-blue-600"><a href="{{route('frontend.post', $post->id)}}">{{$post->title}}</a></h3>
                <div>
